...
def plot_section(file_handle, record, xq, variable='salt',eta='e',clim=(33.8,34.55), plot_grid=True, rep='linear', xlim=(400,800), ylim=(-720,0), cmap=plt.cm.jet):
    ...
    """
    e = file_handle.variables[eta][record,:,0,:] # Vertical grid positions
