...
def driver3D(args):
    ...
    for t in range(tm):
        ...
        if os.path.isfile(path_to_file):
           ...
           # structure
           # layer thickness
           e=Dataset(ocean_file).variables['e'][t,:,:,:]
           ...
           # correct top and bottom, for vis pourposes
           h[0,:,:]=e[0,:,:]; h[-1,:,:]=e[-1,:,:]
           temp=Dataset(ocean_file).variables['temp'][t,:,:,:]
           salt=Dataset(ocean_file).variables['salt'][t,:,:,:]
           tr1=Dataset(ocean_file).variables['tr1'][t,:,:,:]
           ...
           v=Dataset(ocean_file).variables['v'][t,:,:,:]
           u=Dataset(ocean_file).variables['u'][t,:,:,:]
	   ...
	   u=u.filled()
           ...
           VTKgen(lats,lons,D.mask,h=h,temp=temp,salt=salt,dye=tr1,u=u,v=v,fname=name,t=ind)
           ind=ind+1
