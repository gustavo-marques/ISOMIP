...
x = Dataset('../ncfiles/ocean_geometry.nc').variables['lonh'][:] 
y = Dataset('../ncfiles/ocean_geometry.nc').variables['lath'][:] 

# read 3D file
file3D = Dataset('../ncfiles/Ocean1_3D.nc','r+')
...
for j in range(33,36):
    thick[j,0:131] = savitzky_golay(thick[j,0:131], 19, 5)

for j in range(6,9):
    thick[j,0:131] = savitzky_golay(thick[j,0:131], 9, 5)
